...
def build_markdown(provider_name: str) -> str:
    ...
    lines.append("3. rodar `python -m b3_platform.orchestration.validate_active_ci_provider`")
    lines.append("4. rodar `python -m b3_platform.orchestration.show_platform_readiness_report`")
    lines.append("")
